...
import com.hongxiang.kforthirtysix.activity.lol.LolNewsDetailsActivity;
import com.hongxiang.kforthirtysix.adapter.lol.AllLolAdapter;
    ...
    public void initData() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getActivity(), LolNewsDetailsActivity.class);
